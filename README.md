...
The **Core Payment Ledger & Wallet System** is a full-stack financial platform engineered to handle high-frequency and secure monetary transactions. It is built around the principles of **double-entry bookkeeping**, **ACID-compliant transactions** and **distributed concurrency control** — the same foundational concepts used in production systems at companies like Stripe, Wise, and Revolut.
...
![Concurrent Transfer](./docs/screenshots/concurrent-transfer.png)
...
**Team Lead:** Meet Prajapati
📧 meetketanprajapati@gmail.com
💼 [LinkedIn](https://www.linkedin.com/in/meet-prajapati-b5b1312a0/)
🔗 [GitHub](https://github.com/prajapati-meet)

Built by a team of 4 during the Infotact Solutions Software Engineering
Internship (Cohort 26). Feel free to reach out with questions about the
project.

---
<div align="center">

*Built with during the Infotact Solutions Internship Program, 2026*
